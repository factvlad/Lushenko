...
function f10() {
  ...
  for (i = 0; i < a10.length; i++) {
    for (k = 0; k < a10[i].length; k++) {
      if (typeof a10[i][k] != "string") continue;
      else {
        out.push(a10[i][k] + " ");
      }
      div.innerHTML = out;
  ...
  //   for (i = 0; i < a10.length; i++) {
  //     for (k = 0; k < a10[i].length; k++) {
  //       if (typeof a10[i][k] === "string") out.push(a10[i][k] + " ");
  ...
  // for (i = 0; i < a10.length; i++) {
  //   for (k = 0; k < a10[i].length; k++) {
  //     if (typeof a10[i][k] === "string") out[out.length] = a10[i][k] + " ";
