...
function f4() {
    let num1 = +document.querySelector(".i-4").value;
...
function f5() {
    let num1 = +document.querySelector(".i-5").value;
...
function f6() {
    let num1 = +document.querySelector(".i-6").value;
...
function f8() {
    let num1 = +document.querySelector(".s-8").value;
...
function f9() {
    let num1 = +document.querySelector(".i-9").value;
    let out = document.querySelector(".out-9");
    if (num1 >= 1 && num1 <= 32) {
        out.innerHTML = 1;
    } else if (num1 >= 33 && num1 <= 43) {
        out.innerHTML = 2;
    } else if (num1 >= 44 && num1 <= 64) {
        out.innerHTML = 3;
    } else {
        out.innerHTML = 0;
    }
...
function f10() {
    let num1 = +document.querySelector(".s-100").value;
...
function f11() {
    let num1 = +document.querySelector(".s-110").value;
...
function f13() {
    let num1 = document.querySelector(".i-130").value;
    let out = (document.querySelector(".out-13").innerHTML = typeof num1);
}
