...
function t2() {
  let div1 = document.querySelector(".out-2");
  let out = " ";
...
function t3() {
  let div1 = document.querySelector(".out-3");
  let out = " ";
  for (let i = 25; i >= 7; i--) {
    out += i + " ";
  }
...
function t4() {
  let div1 = document.querySelector(".out-4");
  let out = " ";
...
function t5() {
  let div1 = document.querySelector(".out-5");
  let out = " ";
  for (let i = 1; i <= 17; i++) {
    if (i % 2) {
      out += i + "_*";
...
function t7() {
  let div1 = document.querySelector(".out-7");
...
function t8() {
  let div1 = document.querySelector(".out-8");
...
function t11() {
  let div1 = document.querySelectorAll(".div-11");
...
function t13() {
  let inp1 = document.querySelectorAll(".i-13");
